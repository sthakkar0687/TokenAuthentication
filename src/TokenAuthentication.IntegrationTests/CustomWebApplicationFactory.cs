...
namespace TokenAuthentication.IntegrationTests
{
    public class CustomWebApplicationFactory<TStartup> : WebApplicationFactory<TStartup> where TStartup : class
    {
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            {
                var descriptor = services.FirstOrDefault(p => p.ServiceType == typeof(DbContextOptions<TokenAuthenticationDbContext>));
                ...
                using (var scope = sp.CreateScope())
                {
                    ...
                    var dbContext = serviceProvider.GetRequiredService<TokenAuthenticationDbContext>();
        ...
        private void InitializeDbForTests(TokenAuthenticationDbContext context)
        {
